...
oidc_app1_oidc_application_type = "" # optionial - 0 for a web app , 1 for native app, defaults to 0
oidc_app1_token_endpoint_auth_method = "" optionial - token endpoint authentication type. 0 for BASIC,  1 for POST  , 2 for PKCE, defaults to 1
