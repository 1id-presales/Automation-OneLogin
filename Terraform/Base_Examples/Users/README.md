...
- If you are happy with the output of the plan from the previous step proceed to apply the planned changes. Apply the planned changed with the command **terraform apply -var-file "target_ol_env.tfvars"**
- abc
