...
This example will create **a custom attribute (which is called "food" in this example)** and also **two new users** in your <br>
...
- Navigate to the Admin console of your target OneLogin environment and validate that the custom attribute and two new users have been created successfully.
...
- To run a cleanup to remove the custom attribute and these two new users from your target OneLogin environment run the command **terraform destroy -var-file "target_ol_env.tfvars"**.
- Navigate to the Admin console of your target OneLogin environment and validate that the custom attribute and two users created previously have been deleted successfully.
- **END**
