...
This example will create **One new custom field (which is called "food" in this example)** and also **two new users** in your target OneLogin environment and set a value of "pizza" for the **custom attribute** created by this configuration on one of the users. <br>
